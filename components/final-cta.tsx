    ...
    <section className="py-24 px-4 bg-[#f78608] relative overflow-hidden">
      ...
      <div className="container mx-auto max-w-4xl text-center relative z-10">
        ...
        >
          <a
            href="#contato"
            className="group bg-white text-[#f78608] hover:bg-gray-100 rounded-full px-10 py-8 text-xl font-[family-name:var(--font-poppins)] font-semibold shadow-2xl transition-transform hover:scale-105 inline-flex items-center justify-center"
          >
            Começar Agora
