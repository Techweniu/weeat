  ...
  return (
    <section className="py-16 px-4 bg-white">
      <div className="container mx-auto">
        ...
        >
          <h2 className="font-[family-name:var(--font-gate)] text-3xl md:text-4xl text-[#1A1A1A] mb-4">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <motion.div
            ...
            viewport={{ once: true }}
            className="text-center p-8 bg-[#FFFBF5] rounded-2xl"
          >
            <div className="font-[family-name:var(--font-gate)] text-5xl md:text-6xl text-[#F27A23] mb-4">1,6Mi</div>
          ...
          <motion.div
            ...
            className="text-center p-8 bg-[#FFFBF5] rounded-2xl"
          >
            <div className="font-[family-name:var(--font-gate)] text-5xl md:text-6xl text-[#F27A23] mb-4">500 Mil</div>
            <p className="font-[family-name:var(--font-poppins)] text-base text-[#1A1A1A]/80">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="text-center p-8 bg-[#FFFBF5] rounded-2xl border-2 border-[#EF4444]"
          >
